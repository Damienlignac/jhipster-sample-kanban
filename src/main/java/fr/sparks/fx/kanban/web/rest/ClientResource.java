...
import fr.sparks.fx.kanban.domain.Client;
import fr.sparks.fx.kanban.repository.ClientRepository;
...
/**
 * REST controller for managing {@link fr.sparks.fx.kanban.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
